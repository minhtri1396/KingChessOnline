...
public class RawRequester implements IRequester {
    
    public static final RawRequester Instance = new RawRequester();
    
    private RawRequester() {}
    
    @Override
    public byte[] getRequestContent(Object values) {
        return Wrapper.INSTANCE.wrap(new Object[] {
            Converter.toBytes(MessagesManager.PeerMessageType.RAW.rawValue())
        });
    }
