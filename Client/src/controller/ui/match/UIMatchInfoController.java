...
public class UIMatchInfoController extends UIController {
    ...
    private final JPanel playerLabel;
    ...
    public void setPlayerColor(EPieceColors color) {
        if (color == EPieceColors.WHITE) {
