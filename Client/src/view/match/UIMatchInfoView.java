...
public class UIMatchInfoView extends UIView {
    ...
    private void addInfoArea() {
        ...
        this.components.put("PlayerLabel", playerLabel);
    ...
    private void setInfoAreaConstraints() {
        ...
        // playerLabel
        mainLayout.putConstraint(
                SpringLayout.WEST, playerLabel,
                25,
                SpringLayout.EAST, roomNameLabel
        );
        mainLayout.putConstraint(
                SpringLayout.VERTICAL_CENTER, playerLabel,
                0,
                SpringLayout.VERTICAL_CENTER, roomNameLabel
        );
    }
